...
notes_t = (4, 4, 4, 4, 4, 4, 2, 4, 4, 4, 4, 2.1, 4, 4, 4, 4, 4, 4, 4, 2, 4, 4,
           4, 4, 2.1, 4, 4, 4, 2, 4, 4, 2, 4, 4, 4, 4, 2.1, 4)
notes += (13, 13, 14, 13, 12, 6, 12, 11, 7, 13, 12, 11, 99)
notes_t += (4, 4, 4, 4, 4, 4, 2, 4, 4, 4, 4, 2.1, 4)

chord = ([1, 5], [2, 6], [-15, 2], [1, 5], [1, 5], [2, 6], [-15, 2], [1, 5],
         [1, 5], [1, 5], [-16, 3], [-16, 3], [-14, 1], [-15, 2], [1, 5])
