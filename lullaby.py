...
notes = (3, 3, 5, 3, 3, 5, 3, 5, 11, 7, 6, 6, 5, 2, 3, 4, 2, 2, 3, 4, 2, 4,
         ...
         4, 5, 3, 1, 4, 3, 2, 1)
notes_t = (8, 8, 2, 8, 8, 2, 8, 8, 4, 4.1, 8, 4, 4, 8, 8, 4, 4, 8, 8, 2, 8,
           8, 8, 8, 4, 4, 2, 8, 8, 2, 8, 8, 2, 8, 8, 4, 4, 4, 2, 8, 8, 2, 8,
           8, 2, 8, 8, 4, 4, 4, 2.1)

chord = ([99], [1, 3, 5], [1, 3, 5], [1, 3, 5], [-15, -17, 2, 4], [-15, -17,
         2, 4], [-15, -17, 2, 4], [-15, -17, 2, 4], [1, 3, 5], [4, 6, 11],
         [1, 3, 5], [-15, -17, 2, 4], [1, 3, 5], [4, 6, 11], [1, 3, 5],
         [-15, -17, 2, 4], [1, 3, 5])
chord_t = (4, 2.1, 2.1, 2.1, 2.1, 2.1, 2.1, 2.1, 2.1, 2.1, 2.1, 2.1, 2.1,
           2.1, 2.1, 2.1, 2.1)
