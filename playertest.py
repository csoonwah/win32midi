...
# For notes C, D, E, F, G, A, B respectively in an octave
notes = (0, 2, 4, 5, 7, 9, 11)
for octave in range(11):
    for n in notes:
        time.sleep(0.1)
        # Send note ON message to Channel 1
        mr.outShortMsg(0x91, octave * 12 + n, 120)
...
# For playing two different instrument together, we can set the second
...
time.sleep(0.5)
# 1 is the starting channel, playing C chord
mr.playChord([48, 52, 55], 120, 0, 1)
time.sleep(1)
if os.name == 'java':
    import sys
    sys.exit()
